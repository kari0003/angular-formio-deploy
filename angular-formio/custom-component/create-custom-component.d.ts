...
export declare function createCustomFormioComponent(customComponentOptions: FormioCustomComponentInfo): {
    new (component: ExtendedComponentSchema, options: any, data: any): {
        ...
        element: any;
        validators: ("max" | "required" | "custom" | "mask" | "pattern" | "json" | "day" | "minLength" | "maxLength" | "customPrivate" | "min" | "minSelectedCount" | "maxSelectedCount" | "minWords" | "maxWords" | "email" | "url" | "date" | "minDate" | "maxDate")[];
        calculatedValue: any;
        options: any;
        labelElement: any;
        eventHandlers: any[];
